  ...
  return (
    <div className="flex flex-col items-center justify-center px-4 py-4">
      ...
      >
        ...
        <p className="mt-2 text-gray-500">We'd love to hear from you! Reach out with any questions.</p>
      </motion.div>
      ...
      >
        ...
        >
          {loading ? "Sending..."  : <><Send size={20} /> Send Message</>}
            ...
            >
              <a href="https://www.linkedin.com/in/surgenarchs" target="_blank" rel="noopener noreferrer" className="p-3 bg-muted/60 border rounded-full hover:bg-green-600 transition">
                <Linkedin size={24} />
              </a>
              <a href="https://twitter.com/surgenarchs" target="_blank" rel="noopener noreferrer" className="p-3 bg-muted/60 border rounded-full hover:bg-blue-500 transition">
                <Twitter size={24} />
              </a>
              <a href="https://facebook.com/surgenarchs" target="_blank" rel="noopener noreferrer" className="p-3 bg-muted/60 border rounded-full hover:bg-blue-700 transition">
                <Facebook size={24} />
            </a>
            </motion.div>
    </div>
